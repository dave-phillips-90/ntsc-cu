...
![Example NTSC output video](screenshots/ntsc.gif)

This is a Python 3.10 rewrite of [Composite Video Simulator](https://github.com/joncampbell123/composite-video-simulator)
intended for use in analog artifact removal neural networks but can also be used for artistic purposes

The ultimate goal is to reproduce all of the artifacts described [under this list of video artifacts](https://bavc.github.io/avaa/tags.html#video)
...
![Still example of dot crawl](screenshots/DotCrawl_Flat.jpg)
...
![Still example of ringing](screenshots/Ringing1_Flat.jpg)
![Another still example of ringing](screenshots/Ringing2_Flat.jpg)
...
![Still example of chroma delay](screenshots/YCDelayError_Flat.jpg)
...
![Still example of rainbowing](screenshots/rainbow5.jpg)
...
![Still example of chroma noise](screenshots/ChromaNoise_Flat.jpg)
...
![Still example of head switching noise](screenshots/HeadSwitch_Butterfly_SLV-779HF_Sharp1_XCard.jpg)
...
![Still example of oversaturation](screenshots/Oversaturated_Flat.jpg)
